...
import com.hjsoftware.qrbarcodecouponscanner.fragments.CouponCodeFragment;
...
/**
 * Created by hjsoftware on 2/2/18.
 */
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // drawerItem[2] = new NavigationData(R.drawable.arrow,"Change Password");
        ...
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"ScanCoupon").commit();
        setTitle("ScanCoupon");
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                Intent j=new Intent(HomeActivity.this,CouponHistoryActivity.class);
...
//            case 3:
//                Intent c=new Intent(HomeActivity.this,CouponHistoryActivity.class);
